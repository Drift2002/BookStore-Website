    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 to-blue-900/30 relative overflow-hidden">
            ...
            <div className=" container mx-auto px-4 h-screen flex items-center">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full items-center">
                    {/* Text Content */}
                    <div className=" lg:col-span-1 flex flex-col justify-center space-y-6 pl-4 sm:pl-8 lg:pl-12">
                        <motion.h1 initial={{opacity: 0, y: 20}}
                            animate={{opacity: 1, y: 0}}
                            className=" py-2 text-4xl sm:text-5xl md:text-6xl font-bold bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
                                Read <br />Discover <br />Own
                        </motion.h1 >
                        ...
                        <motion.p initial={{opacity: 0}}
                            ...
                            className=" text-lg text-cyan-100/80">
                                Dive into books! Explore our library and build your collection in our bookstore. Your next adventure starts here!
                        </motion.p>
                        ...
                        <motion.div className=" relative w-full h-full"
                            ...
                            transition={{
                                ...
                                <div className=" absolute inset-0 rounded-3xl backdrop-blur-xl overflow-hidden">
                                    <img src={img} alt="BookImage" className=" w-full h-full object-contain p-15" />
                                </div>
